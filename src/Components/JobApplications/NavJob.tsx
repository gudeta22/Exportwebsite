      ...
      <div className="max-w-4xl mx-auto px-6 relative z-10">
        ...
        <div className="text-center">
          <h2 className="text-4xl md:text-5xl font-bold leading-tight mb-6">
            <span className="text-white drop-shadow-lg">Job Application</span>
          </h2>
          <p className="text-lg md:text-xl text-white/90 leading-relaxed max-w-3xl mx-auto drop-shadow-md">
            Join our team and be part of a dynamic and innovative organization. 
            We are committed to fostering a culture of growth, collaboration, 
            and excellence. Explore exciting career opportunities with us and 
